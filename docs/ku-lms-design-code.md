...
- Receipt-style autogenerated subjects such as `レポートを受け取りました [...]` should collapse to the concise prefix in redesigned display surfaces, while native actions/search semantics stay intact underneath.
