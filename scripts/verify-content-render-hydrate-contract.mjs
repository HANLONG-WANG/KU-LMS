...
for (const name of ['renderPage', 'renderShell', 'renderLogin', 'renderLogout', 'renderHome', 'renderCourseMaterials', 'renderMyReports', 'renderNotifications', 'renderMessages', 'renderManual', 'hydrateRouteDom', 'hydrateLoginForm', 'bindInteractiveHandlers']) {
